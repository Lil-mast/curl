...
export default function OpportunityDetailsPage() {
  ...
  const { lang, setLastOpportunityId, listings, listingsReady } = useApp();
  const item = getOpportunity(params.id, listings);
    ...
    return (
      <div className="min-h-screen bg-[#f6f1e8] text-stone-900 px-4 py-16 text-center">
        <p className="text-sm text-stone-600">
          {!listingsReady ? (lang === "so" ? "Waa la diyaarinayaa…" : "Loading listing…") : t("pickListing", lang)}
        </p>
